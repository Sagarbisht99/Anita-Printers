...
export default function PrivacyPage() {
  const schemas = jsonLdGraph(
    webPageJsonLd({
      name: "Privacy Policy",
      description:
        "How Anita Printers collects, uses, and protects contact details, orders, and artwork.",
      path: "/privacy",
    }),
    breadcrumbJsonLd([
      { name: "Home", path: "/" },
    ...
    <>
      ...
      <LegalPage title="Privacy Policy" updated="23 August 2026">
        ...
        <ul>
          ...
          <li>
            Basic technical data such as browser type and approximate location
          </li>
        </ul>
        ...
        <h2>5. Security</h2>
        <p>
          We take reasonable steps to protect personal data. No online
          transmission or storage method is completely secure; please share only
          what is needed for your order.
        </p>
