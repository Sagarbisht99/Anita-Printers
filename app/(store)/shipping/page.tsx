...
export default function ShippingPage() {
  const schemas = jsonLdGraph(
    webPageJsonLd({
      ...
      description:
        "Dispatch timelines, courier partners, and pan-India delivery for Anita Printers orders.",
      path: "/shipping",
    }),
    breadcrumbJsonLd([
      { name: "Home", path: "/" },
  ...
  return (
    <>
      ...
      <LegalPage title="Shipping Policy" updated="23 August 2026">
        ...
        <p>
          Custom print jobs are produced after artwork approval. Shipping
          timelines begin after production is complete, not from the initial
          enquiry date.
        </p>
        ...
        <p>
          Available options and charges are confirmed with your quotation based
          on location, weight, and urgency.
        </p>

        <h2>3. Estimated timelines</h2>
        <p>
          Standard production windows vary by product (cards, apparel, gifts,
          large-format, etc.). We share an estimated dispatch date when your
          order is confirmed. Courier transit time is additional.
        </p>

        <h2>4. Address accuracy</h2>
        <p>
          Please provide a complete and correct delivery address and phone
          number. Delays or failed attempts caused by incorrect details are the
