        ...
        <div className="mx-auto grid max-w-6xl items-center gap-10 px-4 py-14 sm:px-6 sm:py-16 lg:grid-cols-2 lg:gap-14">
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-4">
            <div className="relative col-span-2 aspect-[16/10] overflow-hidden rounded-2xl">
              {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
                  src="https://www.tricityprintmedia.in/assets/images/offset-press.png"
            ...
            <div className="relative aspect-[4/3] overflow-hidden rounded-2xl">
              {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
                  src="https://content.jdmagicbox.com/quickquotes/images_main/advanced-printing-machinery-802697638-bwim86ei.jpg?impolicy=queryparam&im=Resize=(360,360),aspect=fit"
            ...
            <div className="relative aspect-[4/3] overflow-hidden rounded-2xl">
              {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
                  src="https://5.imimg.com/data5/SELLER/Default/2024/2/394191400/GT/JS/OY/8646637/offset-printing-services.jpg"
