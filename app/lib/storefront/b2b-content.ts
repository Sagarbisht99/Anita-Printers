...
export const siteContact = {
  ...
  email: "orders@anitaprinters.com",
  hours: "Mon–Sat, 9:30 AM – 7:00 PM IST",
  addressLines: [
    "Anita Printers Production Hub",
    "Plot 14, Industrial Area Phase II",
    "Gurugram, Haryana 122001",
  ],
  mapEmbed:
    "https://maps.google.com/maps?q=Gurugram%20Industrial%20Area&t=&z=13&ie=UTF8&iwloc=&output=embed",
};
...
export const categoryHighlights = [
  {
    ...
    body: "T-shirts, hoodies, polos, and corporate uniforms with screen, DTF, or embroidery.",
    meta: "MOQ from 25 pcs · 5–12 day lead",
    href: "/products?q=apparel",
    image:
  ...
  },
  {
    id: "cards",
    title: "Bulk Cards",
    body: "Visiting cards, event passes, loyalty cards, and NFC-ready finishes at scale.",
    meta: "MOQ from 100 pcs · 3–7 day lead",
    href: "/products?q=card",
    image:
  ...
  },
  {
    ...
    body: "Letterheads, envelopes, notepads, folders, and branded desk kits for offices.",
    meta: "MOQ from 50 sets · 4–8 day lead",
  ...
  },
  {
    ...
    body: "Bottles, tote bags, pens, notebooks, and conference kits packed for multi-city drops.",
    meta: "MOQ from 50 pcs · 6–14 day lead",
...
export const processSteps = [
  {
    ...
    body: "Pick from apparel, cards, stationery, or merch — or tell us your custom brief.",
  },
  {
    step: "02",
  ...
  },
  {
    ...
    body: "We print, QC, pack, and ship with tracking — single warehouse or multi-city splits.",
  },
];
...
export const printLocations = ["Front chest", "Full front", "Back", "Left sleeve", "Right sleeve", "Neck label"];
...
export const printTechniquesGuide = [
  {
    ...
    bestFor: "Large solid-colour runs on cotton tees and tote bags",
    notes: "Best cost at volume; vibrant opaque colours; ideal for 100+ identical designs.",
  },
  {
    name: "DTF",
...
export const aboutProfile = {
  headline: "Built for bulk. Obsessed with proof quality.",
  body: "Anita Printers is a Gurugram-based production partner for brands, agencies, and corporate procurement teams. Our floor combines apparel decoration, commercial print, and finishing so your merch and stationery ship from one accountable partner.",
  capacity: [
...
export const trustBadges = [
  { label: "B2B print desk", detail: "Human quotes in one business day" },
  { label: "Proof-first", detail: "Nothing prints without your OK" },
  { label: "Scale-ready", detail: "50 to 50,000+ unit runs" },
  { label: "India-wide", detail: "Cartons tracked to your door" },
];
